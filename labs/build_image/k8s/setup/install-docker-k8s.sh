...
[Service]
Environment="HTTP_PROXY=http://user:pass@proxy.example.com:3128/" "HTTPS_PROXY=http://user:pass@proxy.example.com:3128/" "NO_PROXY=registry.cafebazaar.ir:5000,localhost,127.0.0.0/8,10.0.0.0/8,192.168.0.0/16,172.16.0.0/12"
EOF
